...
export default function RoznamaViewScreen() {
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        {/* Card 1: Student Header with Green Completed Badge matching Image 4 */}
        <View style={styles.studentCard}>
          <View style={styles.badgeCol}>
            <BadgeTag status="completed" />
          </View>
        ...
        {isHifz ? (
          // Hifz View Flow matching Image 4
          <>
            {isParaComplete && (
